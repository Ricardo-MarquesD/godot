	...
	if result == HTTPRequest.RESULT_SUCCESS:
		...
		if response_code == 200:
			...
			if conjunto.size() >= 15:
				...
				print("Pergunta1: ",textoPergunta1,",",respostaPergunta1_1,",",respostaPergunta1_2,",",respostaPergunta1_3,",",respostaPergunta1_4)
				print("Pergunta2: ", textoPergunta2,",",respostaPergunta2_1,",",respostaPergunta2_2,",",respostaPergunta2_3,",",respostaPergunta2_4)
				print("Pergunta3: ", textoPergunta3,",",respostaPergunta3_1,",",respostaPergunta3_2,",",respostaPergunta3_3,",",respostaPergunta3_4)
			else:
